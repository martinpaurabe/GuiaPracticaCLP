...
HD_PWD='C:/Users/mpaur/MESE/CLP/GuiaPracticaCLP/SPI_TPF/PruebaVivado/PruebaVivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PruebaTOP_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PruebaTOP_wrapper.tcl
