...
HD_PWD='C:/Users/mpaur/MESE/CLP/GuiaPracticaCLP/SPI_TPF/PruebaVivado/PruebaVivado.runs/PruebaTOP_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PruebaTOP_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PruebaTOP_clk_wiz_0_0.tcl
