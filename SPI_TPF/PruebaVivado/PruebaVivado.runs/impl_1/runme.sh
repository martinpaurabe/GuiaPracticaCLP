...
HD_PWD='C:/Users/mpaur/MESE/CLP/GuiaPracticaCLP/SPI_TPF/PruebaVivado/PruebaVivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PruebaTOP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PruebaTOP_wrapper.tcl -notrace
