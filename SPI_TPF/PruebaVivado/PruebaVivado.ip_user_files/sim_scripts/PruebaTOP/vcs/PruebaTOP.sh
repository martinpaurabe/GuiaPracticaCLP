...
design_libs=(xpm xil_defaultlib xlconstant_v1_1_9)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../PruebaVivado.gen/sources_1/bd/PruebaTOP/ipshared/3242" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../PruebaVivado.gen/sources_1/bd/PruebaTOP/ipshared/3242" \
  ...
  vlogan -work xlconstant_v1_1_9 $vlogan_opts +v2k +incdir+"../../../../PruebaVivado.gen/sources_1/bd/PruebaTOP/ipshared/3242" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PruebaTOP xil_defaultlib.glbl -o PruebaTOP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PruebaTOP_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key PruebaTOP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc PruebaTOP_simv.daidir vcs_lib c.obj)
