...
#
# Script generated by Vivado on Thu Aug 08 22:03:56 -0300 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : PruebaTOP.sh
...
#
# Usage        : PruebaTOP.sh
#                PruebaTOP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PruebaTOP.sh [-reset_run]
#                PruebaTOP.sh [-reset_log]
#                PruebaTOP.sh [-help]
#
...
#                script (type 'PruebaTOP.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname xlconstant_v1_1_9 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib xlconstant_v1_1_9)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "PruebaTOP.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PruebaTOP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../PruebaVivado.gen/sources_1/bd/PruebaTOP/ipshared/3242" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../PruebaVivado.gen/sources_1/bd/PruebaTOP/ipshared/3242" \
  ...
  xmvlog -work xlconstant_v1_1_9 $xmvlog_opts +incdir+"../../../../PruebaVivado.gen/sources_1/bd/PruebaTOP/ipshared/3242" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.PruebaTOP xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.PruebaTOP -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log PruebaTOP_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PruebaTOP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PruebaTOP.sh [-help]\n\
Usage: PruebaTOP.sh [-step]\n\
Usage: PruebaTOP.sh [-lib_map_path]\n\
Usage: PruebaTOP.sh [-reset_run]\n\
Usage: PruebaTOP.sh [-reset_log]\n\
Usage: PruebaTOP.sh [-keep_index]\n\
Usage: PruebaTOP.sh [-noclean_files]\n\n\
