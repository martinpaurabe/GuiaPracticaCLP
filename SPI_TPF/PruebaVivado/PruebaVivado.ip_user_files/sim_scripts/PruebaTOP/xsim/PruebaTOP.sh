...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PruebaTOP xil_defaultlib.PruebaTOP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PruebaTOP -key {Behavioral:sim_1:Functional:PruebaTOP} -tclbatch cmd.tcl -protoinst "protoinst_files/PruebaTOP.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PruebaTOP.wdb xsim.dir libdpi.so)
