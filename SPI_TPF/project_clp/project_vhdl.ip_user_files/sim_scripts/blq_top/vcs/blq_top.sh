...
#
# Script generated by Vivado on Thu Aug 08 23:37:11 -0300 2024
...
#
# Usage        : blq_top.sh
#                blq_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blq_top.sh [-reset_run]
#                blq_top.sh [-reset_log]
#                blq_top.sh [-help]
#
...
#                script (type 'blq_top.sh -help' for more information).
#
...
# script info
echo -e "blq_top.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blq_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_protocol_converter_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/ec67/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/b28c/hdl" +incdir+"../../../../project_vhdl.gen/sources_1/bd/blq_top/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.blq_top xil_defaultlib.glbl -o blq_top_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./blq_top_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key blq_top_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blq_top_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blq_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blq_top.sh [-help]\n\
Usage: blq_top.sh [-step]\n\
Usage: blq_top.sh [-lib_map_path]\n\
Usage: blq_top.sh [-reset_run]\n\
Usage: blq_top.sh [-reset_log]\n\
Usage: blq_top.sh [-keep_index]\n\
Usage: blq_top.sh [-noclean_files]\n\n\
