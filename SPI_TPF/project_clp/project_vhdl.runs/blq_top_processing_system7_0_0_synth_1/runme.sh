...
HD_PWD='C:/Users/mpaur/.Xilinx/PruebaVitis/project_clp/project_vhdl.runs/blq_top_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blq_top_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blq_top_processing_system7_0_0.tcl
