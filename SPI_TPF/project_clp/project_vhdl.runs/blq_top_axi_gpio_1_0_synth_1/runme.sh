...
HD_PWD='C:/Users/mpaur/.Xilinx/Pruebas/project_vhdl/project_vhdl.runs/blq_top_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blq_top_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blq_top_axi_gpio_1_0.tcl
