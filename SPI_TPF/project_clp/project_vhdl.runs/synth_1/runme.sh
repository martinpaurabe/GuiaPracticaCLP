...
HD_PWD='C:/Users/mpaur/.Xilinx/PruebaVitis/project_clp/project_vhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blq_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blq_top_wrapper.tcl
