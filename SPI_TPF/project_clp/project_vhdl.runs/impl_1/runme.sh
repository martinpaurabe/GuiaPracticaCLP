...
HD_PWD='C:/Users/mpaur/.Xilinx/PruebaVitis/project_clp/project_vhdl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blq_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blq_top_wrapper.tcl -notrace
